...
function page() {
  return (
    <div>
      <h2>Conférence Mystique</h2>
      <p className="com">Allocution du Premier Principal</p>
      <p>Principaux : -O-O-O-O-</p>
      <p className="tez">
        <b>TEZ</b> <span className="com">(assis)</span>: Compagnon,
        l’instruction mystique de ce Suprême Degré comprend :
      </p>
      <p>- La démonstration et l’explication de signes Sacrés,</p>
      <p>- La nature et la signification des Mots Sacrés </p>
      <p>
        - Le cérémonial traditionnel que nous devons observer pour échanger et
        communiquer nos secrets.
      </p>
      <p>
        Dans la Maçonnerie de l’Arche Royale, nous reconnaissons cinq s…s,
        nombre correspondent aux Cinq points parfais enseignés aux Maitres
        Maçons.
      </p>
      <p>
        Mais, alors que ces derniers indiquent les devoirs que nous nous devons
        mutuellement les uns les autres, les Signes de l’Arche Royale portent la
        marque particulière de notre dépendance à l’égard du Très Haut, comme
        des créatures qui ont offense Sa Volonté et Son Pouvoir Tout Puissant,
        mains qui demeurent néanmains les enfants adoptifs de Sa Clémence.
      </p>
      <p className="com">
        Le DC dispose alors discrètement un coussin près de la chaire du TE pour
        lui permetre de s'agenouiller. Le TEZ se lève confi son sceptre a J et
        continue.
      </p>
      <p className="tez">
        <b>TEZ </b>: Je vais maintenant exécuter ces signe et vous, Comp
        nouvellement Exalte, levez-vous et imitez-moi.
      </p>
      <p>
        Ceci est le Signe Pénale ; il s'éxécute de la main Gauche, doigts
        joints, en se donnant un coup de tranchant de la main sur la nuque.{" "}
      </p>
      <p>
        C'est le seul signe en Franc-Maçonnerie qui se fasse entièrement de la
        m…n g…e.
      </p>
      <p>
        Ceci est le Signe dAppel ou de Respect, vous devez toujours faire en
        entrant ou sortant du Chapitre et en vous adressant au TEZ. <br />
        Main gauche - pouce caché en visiére - au-dessus des yeux à la hauteur
        du front. Main droite pouce caché - placer à la hauteur du cœur. <br />
      ...
      <p>
       ...
       genoux, bras tendus paume tournées vers le ciel.</span> 
        ...
        l'extrémité des doigts touchant le sol.
      </p>
      <p>
        Veuillez maintenant vous asseoir et je vais vous donner l’explication
        complète de ces Signes.
      </p>
      <p className="com">
        Le TEZ son sceptre toujours sous la garde de Josué. descend de l'estrade
        et continue :
      </p>
      <p>
        Le Signe Pénal rappel le châtiment indiqué dans votre Obligation et
        évoque la chute d’Adam ainsi que le terrible châtiment qui en découla
        pour sa postérité coupable, c’est-à-dire rien moins que la mort. <br />
        L’acte lui-même
      </p>
      ...
      <p>
        ...
        <span className="com">il complète le Signe. </span> C’est dans cette
        attitude expressive que le Père du Genre Humain se présenta devant le
        Très Haut, pour s’entendre notifier Sa sentence, juste bien que
        terrible.{" "}
      </p>
      <p>
        Ce Signe fut ensuite adopté par notre Grand Maître Moise qui lorsque le
        Seigneur lui apparut dans le buisson ardent, au pied du Mont Horeb, dans
        le désert de Sinaï, voilà ainsi ses yeux devant l’éclat de la Divine
        présence
      ...
      <p>
        Le Signe d'Appel ou Signe de Respect peut être aussi considéré à juste
        titre comme l’origine du signe de pénitence ou de Supplication
        <span className="com">fait le signe</span> car il indique vraiment cette
        disposition du cœur et de l’esprit, sans laquelle nos prières et nos
      ...
      <p>
        C’est ainsi qu’Adam s’agenouilla devant Dieu et rendit grâce à Son
        Créateur. Puis il s’inclina, terrifié et contrit, devant son Juge
        offensé, pour détourner Sa colère et se concilier Sa Clémence.{" "}
      </p>
      <p>
        Il a ainsi transmis et pour toujours, à sa postérité coupable, cette
        manifestation extérieure extérieur d’humilité et de contrition.{" "}
      </p>
      <p>
        Le Signe Monitoral <span className="com">fait le signe</span> nous
        rappelle la faiblesse de la nature humaine, incapable de résister à la
        puissance des ténèbres, à moins d’y être aidée par cette Lumière qui
        vient d’En Haut.{" "}
      </p>
      <p className="com">A ces mots le Ppal séj désignele grand VSL</p>
      <p>
      ...
      <p className="com">
        {" "}
        Tandis que discrètement, le DC va mettre le coussin à sa place, le TEZ
        reprend son sceptre des mains de Josué et se place devant l'Autel, face
        à l'Ouest.
      </p>
      <p>
        <b>TES </b>: Pour la construction du Temple du R. S. on employa in grand
        nombre de Maçons et l’on retrouva leurs noms ou leurs marques, gravées
        dans les différentes parties de l’édifice, mais on ne retrouva nulle
      ...
      <p>
        ...
        taillé comme l’Autel des Parfums, et une plaque d’or. Le blanc étant le
        symbole de l’innocence et l’or celui de la pureté.
      </p>
      <p className="com">
        Le TEZ se déplace alors vers le Nord, un peu en avant de l’Autel,
        indique le double cube.
      </p>
      <p>
        <b>TEZ </b>: Sur le côté exposé à l'Ouest, étaient gravées les initiales
        des trois Grands Maîtres qui présidèrent à la construction du Premier
        Temple, à savoir : S. R. d’I., H. R. de T. et H. A.
      </p>
      <p>
        Elles étaient aussi bien destinées à perpétuer leurs noms qu’à évoquer
        les les moyens et les voies d’exécution qui furent utilisé pour cette
        construction.
      </p>
      <p className="com">Le TEZ désigne le triple Tau</p>
      <p>
        Il y avait également le triple Tau, qui était une marque ou un caractère
        que l’on apposait sur les convoctions des Maçons de l’Arche Royale,
        lorsqu’elles revêtaient une importance exceptionnelle. <br />
        Le Tau vient de l’Hébreu, et c’est de cette marque ou de ce signe dont
        parle l’Ange dans la vision d’Ézéchiel, quand il dit à l’homme portant
        l’écritoire :
      </p>
      <p>
        " Passe au milieu de la ville, au milieu de Jérusalem, et fais une
        marque sur le front des hommes qui soupirent et qui gémissent à cause de
        toutes les abominations qui s’y commettent"
        <span className="com">(Ézéchiel IX, verset 4)</span> <br />
      </p>
      <p>
        ...
        du champ de bataille, pour montrer qu’ils étaient parfaitement indemnes.
      </p>
      <p>
...
<p>      Les caractères placés aux angles du triangle présentent une importance
      ...
      <p>
        Telle est, Comp nouvellement exalté, la meilleure explication que je
        puisse vous donner de ces mots et de ces caractères sacrés. Elle prouve
        que l’Arche Royale est l’Apogée de la Franc-Maçonnerie et qu’elle est
        intimement mêlée à tout ce qui sera le plus à notre portée et aura le
        plus de prix pour nous, dans notre existence future. <br />
        <span className="com"></span>
      </p>
      <p>
        Dans tout le cours de cette explication, les questions divines et
        humaines sont constamment liées avec insistance. Partout, et dans les
        moindres détails de ses mystères ineffables, l’Arche Royale enseigne la
        vertu, se consacre à la Gloire de Dieu et tend an bonheur éternel de
        l’humanité. <br />
        Il suffit de dire qu’elle a pour base le nom sacré de J.H.V.H, Qui fut
        de tons les temps, Qui est et Qui restera toujours L’Unique et Le même,
        pour l’Éternité, l’Etre Qui existe nécessairement en Lui et par Lui,
        dans toute Sa perfection, l’Essence de lui-même. <br />
        Compagnons, je vous en conjure, si jamais vous étiez sur le point de
        prononcer ce nom sacré et mystérieux, à la légère ou sans le respect qui
        lui est dú. Arrêtez-vous ! Mettez votre doigt sur vos lèvres et
        souvenez-vous du châtiment indiqué dans votre Obligation. <br />
        <br />
        <span className="com">Le TEZ fait le signe pénal et continue</span>
        <span>
          Ce Suprême Degré insuffle à ses membres la plus haute conception de
          Dieu.
          <br />
          Il conduit à la pratique de la Piété la plus pur et la plus fervente.
          <br />
          Il tend à la vénération de JHVH, <br />
          Celui qu’on ne peut comprendre, <br />
          le Maître Éternel de l’Univers, <br />
          le germe originel de la vie et la source de tous les principes. <br />
          Celui de Qui jaillissent toutes les vertus. <br />
        </span>
      </p>
      <p className="com"></p>
      <p>Fin de la Cérémonie de l’Exaltation.</p>
      <div>
        <NavArche />
      </div>
    </div>
