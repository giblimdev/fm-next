...
function page() {
  return (
    <div>
      ...
      <p>
        <b>2d S </b> : VM, on frappe à la porte de la L.
      </p>
      <p>
        <b>V.M</b> : F 2d S, voyez qui demande l'entrée de la L.
      </p>
      <p>
        <b>2d S </b>
      ...
      <p className="com">
        ...
        de son pied, s'assure que le candidat est convenablement préparé et dit
        a haute voix.
      </p>
      <br />
      <p>
      ...
      <p>
        <b>C </b>: Avec l'aide de Dieu, car il est né libre et il est de bonne
        renommée.
      </p>
      <p>
      ...
      <p>
        <b>VM </b>: Monsieur X...., comme personne ne peut être reçu M. à moins
        d'être né libre et d'être majeur, je vous demande instamment si vous
      ...
      <p>
        <b>E </b>: Monsieur X..., un pauvre candidat privé de l. qui a été
        chaleureusement et honorablement recommandé, régulièrement proposé et
      ...
      <br />
      <span>
        <b>2d S</b>: Entrez, vous qui êtes né libre et de bonne renommée.
      </span>
      <br />
      <span className="com">
        Le 2d S élève légèrement la main du Cand et pour la replacer dans la
        main du 2d E. <br />
        Le 2 E guide le Cand. (par quelques pas coté) pour se remettre sur la
        colonne du midi. <br />
      ...
      <br />
      <span>
        <b>2d E </b>: Monsieur X..., un pauvre candidat privé de l. qui a été
        chaleureusement et honorablement recommandé, régulièrement proposé et
        approuvé en Loge ouverte, et qui se présente aujourd'hui librement et de
        son plein gré, convenablement préparé, pour solliciter humblement d'être
        admis aux mystères et privilèges de la F.M.
      ...
      <br />
      <span>
        <b>1er S </b>: Comment espère-t-il obtenir ces privilèges ?
      </span>
      <br />
      <span>
        <b>2d E </b>: Avec l'aide de Dieu, car il est né libre et il est de
      ...
      <br />
      <span>
        <b>1er S </b>: Entrez, vous qui êtes né libre et de bonne renommée.
      </span>
      <br />
      <p className="com">
      ...
      <p>
        ...
        les t. comme précédemment. Encore un autre un peu plus l. et toujours en
